<template>
	<div class="addEdit-block" :style='{"padding":"20px 30px 30px","margin":"0 auto","color":"#555","borderRadius":"0 0 10px 10px","background":"rgba(255,255,255,.69)","width":"86%","fontSize":"16px"}'>
		...
		>
			<template >
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="零食种类" prop="shangpinzhonglei">
					<el-input  v-model="ruleForm.shangpinzhonglei" placeholder="零食种类" clearable  :readonly="ro.shangpinzhonglei"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="零食种类" prop="shangpinzhonglei">
					<el-input v-model="ruleForm.shangpinzhonglei" placeholder="零食种类" readonly></el-input>
				</el-form-item>
