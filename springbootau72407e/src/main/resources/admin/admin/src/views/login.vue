<template>
  <div>
    <div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(https://pic.imgdb.cn/item/6616bb2768eb93571323d0a1.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
      <el-form :style='{"border":"0px solid #eee","padding":"20px 20px 40px 20px","boxShadow":"0 0px 0px rgba(64, 158, 255, .6)","margin":"0 auto","borderRadius":"0px","textAlign":"center","background":"none","width":"750px","fontSize":"14px","height":"auto"}'>
        <div v-if="true" :style='{"padding":"10px 10px 10px 10px","margin":"0px auto 30px","color":"#FFFF99","textAlign":"center","background":"none","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"30px","fontWeight":"500"}' class="title-container">零食销售商城的设计与实现登录</div>
...
.container {
  ...
  background-size: cover;
      background: url(https://pic.imgdb.cn/item/6616bb2768eb93571323d0a1.jpg);
