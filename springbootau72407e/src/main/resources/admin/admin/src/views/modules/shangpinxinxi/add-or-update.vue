<template>
	<div class="addEdit-block" :style='{"padding":"20px 30px 30px","margin":"0 auto","color":"#555","borderRadius":"0 0 10px 10px","background":"rgba(255,255,255,.69)","width":"86%","fontSize":"16px"}'>
		...
		>
			<template >
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="零食名称" prop="shangpinmingcheng">
					<el-input  v-model="ruleForm.shangpinmingcheng" placeholder="零食名称" clearable  :readonly="ro.shangpinmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="零食名称" prop="shangpinmingcheng">
					<el-input v-model="ruleForm.shangpinmingcheng" placeholder="零食名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="零食种类" prop="shangpinzhonglei">
					<el-select :disabled="ro.shangpinzhonglei" v-model="ruleForm.shangpinzhonglei" placeholder="请选择零食种类" >
						<el-option
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="零食种类" prop="shangpinzhonglei">
					<el-input v-model="ruleForm.shangpinzhonglei"
						placeholder="零食种类" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="upload" v-if="type!='info' && !ro.shangpintupian" label="零食图片" prop="shangpintupian">
					<file-upload
						tip="点击上传零食图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="upload" v-else-if="ruleForm.shangpintupian" label="零食图片" prop="shangpintupian">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="type!='info'"  label="零食详情" prop="shangpinxiangqing">
					<editor 
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.shangpinxiangqing" label="零食详情" prop="shangpinxiangqing">
	...
	data() {
		...
		return {
			...
			rules: {
				...
				shangpinzhonglei: [
					{ required: true, message: '零食种类不能为空', trigger: 'blur' },
				],
				shangpintupian: [
				],
				shangpinxiangqing: [
